...
from load_preprocess_data import preprocess
from utility import append_log_file, silent_remove, down_sample, named_tuple
from utility_train import pickle_tensorflow, _make_models_directory, _load_preprocess_data, \
    _create_tensorboard_dir, _downsample_preprocess
...
class Graph(object):
    ...
    def __init__(self, image_height, image_width, learning_rate):
...
def train(args, args_to_save, number_epochs=1000, checkpoint_number_batches=5, max_number_batches_to_average=1):
    ...
    graph = Graph(image_height=images_train.shape[1],
            ...
            for epoch in range(number_epochs):
                for batch, fraction_of_epoch in batches(images_train, observed_depths_train, graph, args.batch_size):
                    ...
                    if number_batches_processed % checkpoint_number_batches == 0:
                        ...
                        pickle_tensorflow(data_train_sampled.sort_values('start'),
